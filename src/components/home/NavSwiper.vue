<template>
	<div class='navSwiper'>
		<div class='content'>
								...
								<div class='detail-class'>
									...
									>
										...
										<div class='right'>
											...
											<div class="courseDegree">{{ courseType[item.courseLevel] }} · {{ item.purchaseCounter + item.purchaseCnt }}人购买</div>
											<div class='buy'>
												<div class='buy-free'>
			...
			<div class='sliders'>
				<el-carousel 
					:interval="5000" arrow="always"  height="460px"
...
import { getFirstCategorys , getTagsList , getSliders  , searchCourse } from '../../api'
